package com.example.docker_ci.controller;
...
public class MemberController {
    ...
    @PostMapping
    public ResponseEntity<ResponseMemberDto> join(
        @Validated @RequestBody RequestMemberDto requestMemberDto) {
    ...
    @GetMapping("/{email}")
    public ResponseEntity<ResponseMemberDto> findByEmail(@Email @PathVariable String email) {
